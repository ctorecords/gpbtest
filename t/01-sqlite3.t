...
is_deeply(
    {
        message         => $model->{dbh}->selectall_arrayref("select id, created, int_id, str, status, address_id, o_id from message order by o_id", { Slice => {} }),
        message_address => $model->{dbh}->selectall_arrayref("select id, created, address, status from message_address", { Slice => {} }),
        message_bounce  => $model->{dbh}->selectall_arrayref("select created, int_id, address_id, reason_id, o_id, str from message_bounce order by o_id", { Slice => {} }),
        bounce_reasons  => $model->{dbh}->selectall_arrayref("select id, status_code, bounce_type, reason from bounce_reasons", { Slice => {} }),
        log             => $model->{dbh}->selectall_arrayref("select created, int_id, str, address_id, o_id from log order by o_id", { Slice => {} }),
    },
    {
        message         => [],
        message_address => [
